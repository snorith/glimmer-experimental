 ...
 */
export const GLIMMERX_COMPONENT_IMPORTS = [
  '@glimmerx/component',
  '@norith/glimmerx-component',
];

export const GLIMMERX_CORE_IMPORTS = [
  '@glimmerx/core',
  '@norith/glimmerx-core',
];

export const GLIMMERX_HELPER_IMPORTS = [
  '@glimmerx/helper',
  '@norith/glimmerx-helper',
];

export const GLIMMERX_MODIFIER_IMPORTS = [
  '@glimmerx/modifier',
  '@norith/glimmerx-modifier',
];
